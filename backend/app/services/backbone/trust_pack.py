...
class TrustPack:
    ...
    def generate_trust_pack(workspace_data: dict, offer_data: dict) -> dict:
        ...
        return {
            ...
            "due_diligence_items": [
                f"Certificate of Insurance (E&O, Cyber Liability)",
                f"SOC 2 Type II audit report (latest)",
                f"Client reference list (anonymized upon request)",
                f"Data security and privacy policy documentation",
                f"Business continuity and disaster recovery plan",
                f"Team background check confirmation",
                f"Sample engagement deliverables (redacted)",
            ],
            "briefing_deck_outline": [
                f"Slide 1: About {firm_name} — mission, history, team",
                f"Slide 2: The Problem — why HNW clients need {offer_name}",
                f"Slide 3: Our Approach — methodology and delivery model",
                f"Slide 4: What You Get — deliverables and outcomes",
                f"Slide 5: Proof of Results — case studies and KPIs",
                f"Slide 6: Security & Privacy — how we protect your data",
                f"Slide 7: Engagement Model — timeline, pricing, next steps",
                f"Slide 8: FAQ — common questions and answers",
            ],
